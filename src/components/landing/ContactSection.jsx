...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="page-section py-16 px-6 bg-gray-50 dark:bg-gray-800">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          >
            Ready to transform your construction projects? Contact our team for a personalized consultation.
          </motion.p>
        </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-600 dark:text-gray-300">
                <li className="flex items-start">
                  ...
                  24/7 support for urgent project needs
                </li>
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-blue-600 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                  Local expertise in Malaysian construction regulations
                </li>
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-blue-600 rounded-full mt-2 mr-3 flex-shrink-0"></span>
